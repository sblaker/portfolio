...
export const myProjects: Project[] = [
  {
    ...
    description: "My thesis project on creating an IDS using Machine Learning to detect unknown threats.",
    fullDescription:
  ...
  },
  {
    ...
    description: "Participation in the national cybersecurity training program and CTF competition.",
    fullDescription:
